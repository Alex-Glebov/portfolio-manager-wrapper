"""
Asynchronous authentication and token management for Portfolio Manager Wrapper.
...
class AsyncTokenManager:
    """Manages authentication tokens with automatic refresh (async version)."""
    ...
    async def ensure_token(self, buffer_seconds: int = 60) -> str:
